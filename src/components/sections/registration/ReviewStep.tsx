    ...
    <div className="flex animate-fade-up flex-col gap-6">
      ...
      <div className="rounded-2xl border border-border bg-cream-50 p-5">
        ...
        <p className="mt-3 text-xs leading-relaxed text-muted">
          By proceeding to payment, you agree to the NEETI MUN{" "}
          <Link href="/terms-of-service" className="underline decoration-gold-500 decoration-2 underline-offset-2 hover:text-navy-900">
            Terms of Service
          </Link>
          ,{" "}
          <Link href="/privacy-policy" className="underline decoration-gold-500 decoration-2 underline-offset-2 hover:text-navy-900">
            Privacy Policy
          </Link>
          , and{" "}
          <Link href="/code-of-conduct" className="underline decoration-gold-500 decoration-2 underline-offset-2 hover:text-navy-900">
            Code of Conduct
          </Link>
          .
        </p>
