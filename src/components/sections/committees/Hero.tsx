  ...
  return (
    <section className="bg-cream-100">
      <Container className="flex flex-col items-center gap-6 py-28 text-center sm:py-36">
        ...
        <h1 className="animate-fade-up font-display max-w-3xl text-4xl leading-tight text-navy-900 [animation-delay:100ms] sm:text-5xl lg:text-6xl">
        ...
        <p className="animate-fade-up max-w-2xl text-base leading-relaxed text-muted [animation-delay:200ms]">
          ...
          most critical decision-making bodies. We invite delegates to
          engage with policy-making that defines the coming decades.
        </p>
        <span className="animate-fade-up mt-4 h-px w-16 bg-gold-500 [animation-delay:300ms]" />
      </Container>
    </section>
  );
}
